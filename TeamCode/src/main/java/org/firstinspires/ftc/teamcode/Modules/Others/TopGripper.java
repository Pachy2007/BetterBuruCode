...
public class TopGripper {
    ...
    {
        BottomGripper.State.OPEN.position=openPos;
        BottomGripper.State.OPENING.position=openPos;

        BottomGripper.State.CLOSE.position=closePos;
        BottomGripper.State.CLOSING.position=closePos;
    }
